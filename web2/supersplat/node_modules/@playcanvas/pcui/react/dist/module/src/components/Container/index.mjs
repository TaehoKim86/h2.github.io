import { CLASS_FLEX, CLASS_GRID, CLASS_SCROLLABLE, CLASS_RESIZABLE } from '../../class.mjs';
 ...
 * ```
 */
Container$1.EVENT_APPEND = 'append';
/**
 ...
 * ```
 */
Container$1.EVENT_REMOVE = 'remove';
/**
 ...
 * ```
 */
Container$1.EVENT_SCROLL = 'scroll';
/**
 ...
 * ```
 */
Container$1.EVENT_RESIZE = 'resize';
Element$1.register('container', Container$1);
