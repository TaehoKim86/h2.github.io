 ...
 */
let NumericInput$1 = class NumericInput extends InputElement {
    /**
...
Element$1.register('number', NumericInput$1, { renderChanges: true });

export { NumericInput$1 as NumericInput };
