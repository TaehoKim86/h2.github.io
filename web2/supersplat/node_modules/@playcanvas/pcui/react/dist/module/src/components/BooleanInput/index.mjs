 ...
 * A checkbox element.
 */
let BooleanInput$1 = class BooleanInput extends Element$1 {
    /**
...
Element$1.register('boolean', BooleanInput$1, { renderChanges: true });

export { BooleanInput$1 as BooleanInput };
