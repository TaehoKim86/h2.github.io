import { CLASS_FONT_BOLD, CLASS_COLLAPSED, CLASS_COLLAPSIBLE } from '../../class.mjs';
 ...
 */
let Panel$1 = class Panel extends Container$1 {
    /**
     * Creates a new Panel.
     *
    ...
    _initializeHeader(args) {
        // header container
        this._containerHeader = new Container$1({
            flex: true,
            flexDirection: 'row',
            class: [CLASS_PANEL_HEADER, CLASS_FONT_BOLD]
        });
        // header title
        this._labelTitle = new Label$1({
    ...
    _initializeContent(args) {
        ...
        this._containerContent = new Container$1({
 ...
 * ```
 */
Panel$1.EVENT_COLLAPSE = 'collapse';
/**
 ...
 * ```
 */
Panel$1.EVENT_EXPAND = 'expand';
Element$1.register('panel', Panel$1);

export { Panel$1 as Panel };
