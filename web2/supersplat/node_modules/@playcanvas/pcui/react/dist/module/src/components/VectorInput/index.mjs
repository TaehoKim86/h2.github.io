 ...
 */
let VectorInput$1 = class VectorInput extends Element$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        for (let i = 0; i < dimensions; i++) {
            const input = new NumericInput$1({
                min: args.min,
                max: args.max,
...
Element$1.register('vec2', VectorInput$1, { dimensions: 2, renderChanges: true });
Element$1.register('vec3', VectorInput$1, { dimensions: 3, renderChanges: true });
Element$1.register('vec4', VectorInput$1, { dimensions: 4, renderChanges: true });

export { VectorInput$1 as VectorInput };
