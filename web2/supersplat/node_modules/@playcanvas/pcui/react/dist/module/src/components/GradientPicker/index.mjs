import { _rgb2hsv, _hsv2rgb } from '../../Math/color-value.mjs';
import { Button as Button$1 } from '../Button/index.mjs';
import { Canvas as Canvas$1 } from '../Canvas/index.mjs';
import { Element as Element$1 } from '../Element/index.mjs';
import { Label as Label$1 } from '../Label/index.mjs';
import { NumericInput as NumericInput$1 } from '../NumericInput/index.mjs';
import { Overlay as Overlay$1 } from '../Overlay/index.mjs';
import { Panel as Panel$1 } from '../Panel/index.mjs';
import { SelectInput as SelectInput$1 } from '../SelectInput/index.mjs';
import { TextInput as TextInput$1 } from '../TextInput/index.mjs';
 ...
 */
let GradientPicker$1 = class GradientPicker extends Element$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        this._canvas = new Canvas$1({ useDevicePixelRatio: true });
        ...
        this._panel = new Panel$1();
        this._panel.class.add('color-panel');
        this.dom.appendChild(this._panel.dom);
        this._colorRect = new Canvas$1({ useDevicePixelRatio: true });
        ...
        this._hueRect = new Canvas$1({ useDevicePixelRatio: true });
        ...
        this._alphaRect = new Canvas$1({ useDevicePixelRatio: true });
        ...
        function numberField(label) {
            const field = new NumericInput$1({
                precision: 1,
                step: 1,
                min: 0,
                max: 255
        ...
        this._hexField = new TextInput$1();
        ...
        this.UI = {
            ...
            gradient: new Canvas$1({ useDevicePixelRatio: true }),
            checkerPattern: this.createCheckerPattern(),
            anchors: new Canvas$1({ useDevicePixelRatio: true }),
            footer: new Panel$1(),
            typeLabel: new Label$1({ text: 'Type' }),
            typeCombo: new SelectInput$1({
                options: [{ t: '0', v: 'placeholder' }],
                type: 'number'
            }),
            positionLabel: new Label$1({ text: 'Position' }),
            positionEdit: new NumericInput$1({ min: 0, max: 100, step: 1 }),
            copyButton: new Button$1(),
            pasteButton: new Button$1(),
            deleteButton: new Button$1(),
            showSelectedPosition: new NumericInput$1({ min: 0, max: 100, step: 1, hideSlider: true }),
...
Element$1.register('div', GradientPicker$1);

export { GradientPicker$1 as GradientPicker };
