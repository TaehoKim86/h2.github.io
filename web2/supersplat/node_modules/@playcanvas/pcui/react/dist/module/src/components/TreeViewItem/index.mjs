import { CLASS_FONT_REGULAR } from '../../class.mjs';
 ...
 */
let TreeViewItem$1 = class TreeViewItem extends Container$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        this._containerContents = new Container$1({
    ...
    rename() {
        ...
        const textInput = new TextInput$1({
            renderChanges: false,
            value: this.text,
 ...
 * ```
 */
TreeViewItem$1.EVENT_SELECT = 'select';
/**
 ...
 * ```
 */
TreeViewItem$1.EVENT_DESELECT = 'deselect';
/**
 ...
 * ```
 */
TreeViewItem$1.EVENT_OPEN = 'open';
/**
 ...
 * ```
 */
TreeViewItem$1.EVENT_CLOSE = 'close';

export { TreeViewItem$1 as TreeViewItem };
