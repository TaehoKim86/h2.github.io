 ...
 */
let ColorPicker$1 = class ColorPicker extends Element$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        // HEX
        this._fieldHex = new TextInput$1({
...
Element$1.register('rgb', ColorPicker$1);
Element$1.register('rgba', ColorPicker$1, { channels: 4 });
