 ...
 */
let ArrayInput$1 = class ArrayInput extends Element$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        this._inputSize = new NumericInput$1({
        ...
        this._containerArray = new Container$1({
...
for (const type in ArrayInput$1.DEFAULTS) {
    Element$1.register(`array:${type}`, ArrayInput$1, { type: type, renderChanges: true });
}
Element$1.register('array:select', ArrayInput$1, { type: 'select', renderChanges: true });

export { ArrayInput$1 as ArrayInput };
