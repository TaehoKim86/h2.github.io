 ...
 */
let SelectInput$1 = class SelectInput extends Element$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        this._containerValue = new Container$1({
        ...
        // dropdown list
        this._containerOptions = new Container$1({
            class: CLASS_LIST,
            hidden: true
        });
        this._containerValue.append(this._containerOptions);
        // tags container
        this._containerTags = new Container$1({
            class: CLASS_TAGS,
            flex: true,
            flexDirection: 'row',
            hidden: true
    ...
    _initializeCreateLabel() {
        ...
        const labelCreateText = new Label$1({
    ...
    _addTag(value) {
        ...
        container.append(new Label$1({
            text: this._valueToText[value] || value
        }));
        const btnRemove = new Button$1({
            size: 'small',
            icon: 'E132',
            tabIndex: -1
        });
...
Element$1.register('select', SelectInput$1, { renderChanges: true });
Element$1.register('multiselect', SelectInput$1, { multiSelect: true, renderChanges: true });
Element$1.register('tags', SelectInput$1, { allowInput: true, allowCreate: true, multiSelect: true, renderChanges: true });

export { SelectInput$1 as SelectInput };
