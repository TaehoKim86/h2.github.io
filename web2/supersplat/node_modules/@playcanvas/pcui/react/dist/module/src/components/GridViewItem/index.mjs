...
import { RadioButton as RadioButton$1 } from '../RadioButton/index.mjs';
 ...
 */
let GridViewItem$1 = class GridViewItem extends Container$1 {
    /**
    ...
    constructor(args = {}) {
        ...
        if (args.type === 'radio') {
            ...
            this._radioButton = new RadioButton$1({
...
export { GridViewItem$1 as GridViewItem };
