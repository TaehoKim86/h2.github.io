...
class ScriptHandler extends ResourceHandler {
  ...
  _loadModule(url, callback) {
    ...
    import(/* @vite-ignore */ /* webpackIgnore: true */ importUrl.toString()).then(module => {
      var _this$_app$assets$fin;
      const filename = importUrl.pathname.split('/').pop();
      const scriptSchema = (_this$_app$assets$fin = this._app.assets.find(filename, 'script')) == null || (_this$_app$assets$fin = _this$_app$assets$fin.data) == null ? void 0 : _this$_app$assets$fin.scripts;
