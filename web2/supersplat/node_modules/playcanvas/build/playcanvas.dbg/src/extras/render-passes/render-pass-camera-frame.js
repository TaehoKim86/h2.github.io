...
import { PIXELFORMAT_RGBA8, FILTER_LINEAR, ADDRESS_CLAMP_TO_EDGE, PIXELFORMAT_DEPTHSTENCIL, PIXELFORMAT_DEPTH, FILTER_NEAREST, PIXELFORMAT_R32F } from '../../platform/graphics/constants.js';
...
class RenderPassCameraFrame extends RenderPass {
  ...
  setupRenderPasses(options) {
    ...
    this.rt = new RenderTarget({
      ...
      flipY: !!(targetRenderTarget != null && targetRenderTarget.flipY) // flipY is inherited from the target renderTarget
    });
    this.sceneOptions = {
