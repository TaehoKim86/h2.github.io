...
class WebglGraphicsDevice extends GraphicsDevice {
  ...
  readTextureAsync(texture, x, y, width, height, options) {
    var _options$face, _options$renderTarget, _options$data;
    ...
    const data = (_options$data = options.data) != null ? _options$data : new (getPixelFormatArrayType(texture._format))(buffer);
