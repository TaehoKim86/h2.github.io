...
class RenderPass {
  ...
  allocateAttachments() {
    ...
    for (let i = 0; i < numColorOps; i++) {
      ...
      if ((_this$renderTarget = this.renderTarget) != null && _this$renderTarget.mipmaps && (_this$renderTarget2 = this.renderTarget) != null && (_this$renderTarget2 = _this$renderTarget2._colorBuffers) != null && _this$renderTarget2[i].mipmaps) {
  ...
  log(device, index = 0) {
    if (Tracing.get(TRACEID_RENDER_PASS) || Tracing.get(TRACEID_RENDER_PASS_DETAIL)) {
      var _this$renderTarget3, _rt$_colorBuffers$len2, _rt$_colorBuffers2;
      const rt = (_this$renderTarget3 = this.renderTarget) != null ? _this$renderTarget3 : this.renderTarget === null ? device.backBuffer : null;
      ...
      const mipLevel = rt == null ? void 0 : rt.mipLevel;
      ...
      for (let i = 0; i < numColor; i++) {
        ...
        Debug.trace(TRACEID_RENDER_PASS_DETAIL, `    color[${i}]: ` + `${colorOps.clear ? 'clear' : 'load'}->` + `${colorOps.store ? 'store' : 'discard'} ` + `${colorOps.resolve ? 'resolve ' : ''}` + `${colorOps.genMipmaps ? 'mipmaps ' : ''}` + ` [format: ${colorFormat}]`);
      }
