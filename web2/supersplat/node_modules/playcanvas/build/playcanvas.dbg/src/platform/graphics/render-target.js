...
class RenderTarget {
   ...
   */
  constructor(options = {}) {
    var _ref, _ref2, _options$colorBuffer$, _options$colorBuffer, _options$colorBuffers, _options$depthBuffer, _options$samples, _options$face, _options$autoResolve, _options$flipY, _options$mipLevel, _this$_colorBuffers;
    /**
  ...
  destroyTextureBuffers() {
    var _this$_depthBuffer2, _this$_colorBuffers2;
  ...
  get width() {
    var _this$_width;
    return (_this$_width = this._width) != null ? _this$_width : this._device.width;
  }
  ...
  get height() {
    var _this$_height;
    return (_this$_height = this._height) != null ? _this$_height : this._device.height;
  }
  updateDimensions() {
    var _this$_colorBuffer$wi, _this$_colorBuffer2, _this$_depthBuffer4, _this$_colorBuffer$he, _this$_colorBuffer3, _this$_depthBuffer5;
    this._width = (_this$_colorBuffer$wi = (_this$_colorBuffer2 = this._colorBuffer) == null ? void 0 : _this$_colorBuffer2.width) != null ? _this$_colorBuffer$wi : (_this$_depthBuffer4 = this._depthBuffer) == null ? void 0 : _this$_depthBuffer4.width;
    this._height = (_this$_colorBuffer$he = (_this$_colorBuffer3 = this._colorBuffer) == null ? void 0 : _this$_colorBuffer3.height) != null ? _this$_colorBuffer$he : (_this$_depthBuffer5 = this._depthBuffer) == null ? void 0 : _this$_depthBuffer5.height;
